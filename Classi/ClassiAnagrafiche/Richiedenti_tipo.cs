...
namespace TheSite.Classi.ClassiAnagrafiche
{
	...
	/// </summary>
	public class Richiedenti_tipo : AbstractBase
	{
		public Richiedenti_tipo()
		{
			//
		...
		public override DataSet GetData(S_ControlsCollection CollezioneControlli)
		{
			...
			string s_StrSql = "PACK_RICHIEDENTI_TIPO.SP_GETRICHIEDENTI_TIPO";
		...
		public DataSet GetAllData()
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDL=new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_RICHIEDENTI_TIPO.SP_GETALLRICHIEDENTI_TIPO";
			_Ds=_OraDL.GetRows(CollezioneControlli,s_StrSql).Copy();
			return _Ds;
		}
		public DataSet GetAllAddProg(string id_prog)
		{
			DataSet _Ds;
			S_ControlsCollection CollezioneControlli=new S_ControlsCollection(); 
			...
			S_p_progetto.Index = 0;
			if(id_prog!="")
			S_p_progetto.Value=Convert.ToInt32(id_prog);
			else
			S_p_progetto.Value=0;
		...
		public override DataSet GetSingleData(int itemId)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_RICHIEDENTI_TIPO.SP_GETSINGLERICHIEDENTI_TIPO";	
		...
		protected override int ExecuteUpdate(S_ControlsCollection CollezioneControlli, ExecuteType Operazione, int itemId)
		{
			...
			int i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_RICHIEDENTI_TIPO.SP_EXECUTERICHIEDENTI_TIPO");

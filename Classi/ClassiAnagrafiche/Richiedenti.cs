...
namespace TheSite.Classi.ClassiAnagrafiche
{
	...
	/// </summary>
	public class Richiedenti : AbstractBase
	{
		public Richiedenti()
		{
			//
		...
		public DataSet CheckData(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;
			//S_ControlsCollections CollezioneControlli=new S_ControlsCollection(); 
			...
			ApplicationDataLayer.OracleDataLayer _OraDL=new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_RICHIEDENTI.SP_CHECKRICHIEDENTI";
			_Ds=_OraDL.GetRows(CollezioneControlli,s_StrSql).Copy();
			return _Ds;
		}
		...
		public  DataSet GetSingleData1(string p_cognome)
		{
			DataSet _Ds;
			...
			S_Controls.Collections.S_Object s_Id = new S_Object();
			s_Id.ParameterName = "p_cognome";
			s_Id.DbType = CustomDBType.VarChar;
			s_Id.Direction = ParameterDirection.Input;
			s_Id.Index = 0;
			s_Id.Value = p_cognome;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_RICHIEDENTI.SP_GETSINGLERICHIEDENTI1";	
			_Ds = _OraDl.GetRows(_SColl, s_StrSql).Copy();			
		...
		protected override int ExecuteUpdate(S_ControlsCollection CollezioneControlli, ExecuteType Operazione, int itemId)
		{
			...
			int i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_RICHIEDENTI.SP_EXECUTERICHIEDENTI");

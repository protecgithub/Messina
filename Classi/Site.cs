...
{	
	...
	public class GestoreDropDownList
	{
		...
		/// <returns></returns>
public static DataTable ItemBlankDataSource (DataTable DataTableOrigine, string DataTextField, string DataValueFiled,	string BlankText, string BlankValue)
		{

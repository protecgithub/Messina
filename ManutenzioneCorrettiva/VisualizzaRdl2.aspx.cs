...
{
	/// <summary>
	/// Descrizione di riepilogo per VisualizzaRdl2.
	/// </summary>
	public class VisualizzaRdl2 : System.Web.UI.Page
	{
		...
		private void btnsNuova_Click(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("CreazioneSGA2.aspx?FunId=" + FunId + VarApp);
		}
		...
		private void btnModificaRDL_Click(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("CreazioneSGA2.aspx?ItemId=" + txtWrHidden.Text + VarApp);			
		}

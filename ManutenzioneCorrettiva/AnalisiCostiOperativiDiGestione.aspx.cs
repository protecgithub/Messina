	...
	public class AnalisiCostiOperativiDiGestione : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			{	
				...
				//*****************
				if(Context.Handler is TheSite.ManutenzioneCorrettiva.AnalisiCostiOperativiDiGestioneDettaglio)
				{
					_fp2 = (TheSite.ManutenzioneCorrettiva.AnalisiCostiOperativiDiGestioneDettaglio)Context.Handler;
					if (_fp2!=null) 
					{						
		...
		private void BindStatus()
		{
			...
			ListItem lstAttivitaCompletata = new ListItem("Attività Completata","4");
			cmbsStatus.Items.Add(lstAttivitaCompletata);
//			Classi.ManStraordinaria.Richiesta  _Richiesta= new Classi.ManStraordinaria.Richiesta();
//						
//			DataSet Ds = _Richiesta.GetStatusCompletata();
//		
//			if (Ds.Tables[0].Rows.Count > 0)
//			{
//				DataTable tbVuota = new DataTable();
//				DataColumn clDescrizione = new DataColumn("DESCRIZIONE","System.String");
//				DataColumn clId = new DataColumn("ID","System.String");
//				tbVuota.Columns.Add(clDescrizione);
//				tbVuota.Columns.Add(clId);
//				this.cmbsStatus.DataSource = Classi.GestoreDropDownList.ItemBlankDataSource(
//					tbVuota, "DESCRIZIONE", "ID", "Attività Completata", "4");

...
<%@ Page language="c#" Codebehind="SfogliaRdlPaging1.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneCorrettiva.SfogliaRdlPaging1" %>
                  ...
                  target=_blank>Guida</A></TD>
									...
									<TR id="trstraordinaria">
										<TD vAlign="top" align="center" width="100%"><uc1:gridtitle id="GridTitle1" runat="server"></uc1:gridtitle><asp:datagrid id="DataGridRicerca" runat="server" CssClass="DataGrid" ShowFooter="True" AllowPaging="True"
												BorderColor="Gray" AllowCustomPaging="True" BorderWidth="1px" GridLines="Vertical" AutoGenerateColumns="False" Width="100%">

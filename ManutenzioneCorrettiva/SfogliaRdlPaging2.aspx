...
<%@ Page language="c#" Codebehind="SfogliaRdlPaging2.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneCorrettiva.SfogliaRdlPaging2" %>
			...
			<TABLE style="Z-INDEX: 101; POSITION: absolute; TOP: 0px; LEFT: 0px" id="TableMain" border="0"
				...
				<TBODY>
										...
										<TD style="HEIGHT: 25%" vAlign="top" align="left"><COLLAPSE:DATAPANEL id="PanelRicerca" runat="server" ExpandImageUrl="../Images/down.gif" CollapseImageUrl="../Images/up.gif"
												...
												<TABLE id="tblSearch100" border="0" cellSpacing="1" cellPadding="2">
													...
													<TR>
														...
														<TD>
															<cc1:S_ComboBox id="cmbsStatus" runat="server" Visible="False" Width="99%"></cc1:S_ComboBox></TD>
														...
														<TD>
															<cc1:s_textbox id="txtsOrdine" runat="server" DBParameterName="p_Wr_Id" DBDirection="Input" width="100px"
																DBSize="255" MaxLength="10" Visible="False"></cc1:s_textbox></TD>
													</TR>
													<TR>
														...
														<TD>
															<cc1:S_ComboBox id="cmbsGruppo" runat="server" Visible="False" Width="99%"></cc1:S_ComboBox></TD>
													</TR>
													<TR>
														<TD align="left"><!--Richiedente:--></TD>
														<TD>
															<uc1:Richiedenti id="Richiedenti1" runat="server" Visible="False"></uc1:Richiedenti></TD>
														<TD align="left"><!--Priorità:--></TD>
														<TD>
															<cc1:S_ComboBox id="cmbsUrgenza" runat="server" Visible="False" Width="99%"></cc1:S_ComboBox></TD>
													</TR>
													<TR>
													...
													<TR>
														...
														<TD>
															<cc1:S_ComboBox id="cmbsTipoManutenzione" runat="server" Visible="False" Width="99%"></cc1:S_ComboBox></TD>
                  ...
                  target=_blank>Guida</A></TD>
									...
									<TR id="trrichiesta">
										<TD vAlign="top" width="100%" align="center"><uc1:gridtitle id="Gridtitle2" runat="server"></uc1:gridtitle><asp:datagrid id="DataGridRicerca2" runat="server" CssClass="DataGrid" AutoGenerateColumns="False"
												...
												<Columns>
													...
													<asp:TemplateColumn Visible="False">
														...
														<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
														<ItemTemplate>
															<asp:ImageButton id="Imagebutton3" Runat="server" CommandName="Modifica" ImageUrl="../images/Search16x16_bianca.JPG" CommandArgument='<%# "CreazioneSGA1.aspx?ItemId=" + DataBinder.Eval(Container.DataItem,"WR_ID")%>'>
															</asp:ImageButton>
														</ItemTemplate>
													</asp:TemplateColumn>
													<asp:BoundColumn DataField="EDIF" HeaderText="EDIF."></asp:BoundColumn>
